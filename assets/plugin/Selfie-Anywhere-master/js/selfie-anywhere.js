...
const backgrounds = ["ccc", "test", "3warna"];
...
$("#arrowLeft").click(function () {
    ...
    $('#selfie-anywhere-app').css('background-image', 'url( assets/plugin/Selfie-Anywhere-master/'+ backgroundImagesPath + backgrounds[currentBGIndex] +'.jpeg)');
    $('#background-container').css('background-image', 'url( assets/plugin/Selfie-Anywhere-master/'+ backgroundImagesPath + backgrounds[currentBGIndex] +'.jpeg)');
});
